...
The three hosts with an unknown MAC vendor should be identified through authorized administrative or network-management records. The host `10.11.12.249` should also be investigated because the supplied output reports it as up without MAC/vendor information.
